		...
		<div class="content login">
			<div class="wcon clearfix">
				...
				<div class="lgright fr">
					<div class="lrtitle"> <strong class="fl">账户登录</strong>
						<span class="fr">
							还没账号？
							<a href="/zhongying1/index.php/Reg/index">立即注册</a>
						</span>
					</div>
					<div id="lrform">
						<form name="login" id="login" action="/zhongying1/index.php/Login/login_do" onSubmit="return false;">
							<input type="hidden" name="_csrf" value="715b706e-71a8-440d-87d6-16980ca727b2"/>
							<div class="rl_input"> <i class="phoneicon"></i>
								<input type="text" name="username" id="username" class="input" placeholder="请输入手机号码" maxlength="50" autocomplete="off"
							...
							<div class="links">
								<a href="/zhongying1/index.php/Reg/forget" class="fl">忘记密码?</a>
								<a href="/zhongying1/index.php/Reg/index" class="fr">免费注册</a>
							</div>
						</form>
					</div>
				</div>
