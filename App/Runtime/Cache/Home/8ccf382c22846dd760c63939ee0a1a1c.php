  ...
  <div class = "header fixed active" style = "display:none">
        ...
        <div class="content user">
            <div class="wcon">
                ...
                <div class="user_right fr">
                    <ul class="tit">
                        <li class="nocur">
                            <a href="/zhongying1/index.php/My/withdraw.html">账户提现</a>
                        </li>
                        <li>
                    ...
                    <div class="search">
                        <div class="sch">
                            <form action="/user/user_withdraw_list_ajax" name="pagelist" id="pagelist">
    ...
    function withdraw_list(){
        ...
        ajax.submit(url,data,function(d){
            var con='<div class="tablebox"><table width="95%;" border="0" cellpadding="0" cellspacing="0" class="mtable"><thead><tr><td>提现金额(￥)</td><td>手续费(￥)</td><td>收款人</td><td>银行账号</td><td>提现时间</td><td>状态</td></tr></thead><tbody>'
            ...
            if(d.success==false){
                ...
                con += '<tr><td colspan="6">未查询到相关记录</td></tr>';
                    ...
                    for(var i=0;i<d.data.list.length;i++){
                        ...
                        con +='<tr><td>'+data.money+'</td><td>'+data.fee+'</td><td>'+data.realnameEnc+'</td><td>***'+data.cardnoEnc+'</td><td>'+data.begintimeShow+'</td><td><b class="'+scls+'">'+data.statusShow+'</b></td><td></td></tr>';
                    }
