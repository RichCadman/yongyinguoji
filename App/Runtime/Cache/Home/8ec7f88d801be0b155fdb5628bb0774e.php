...
<head lang = "zh">
    ...
    >
    <link href = "/zhongying1/Pub/home/css/helpDetail.css" rel = "stylesheet">
...
<body class = "zh">
    ...
    <div class = "header active">
        <div class = "nav clearfix">
            ...
            <nav class = "nav-menus">
                ...
                <a href = "/zhongying1/index.php/Help/index" class = "active">帮助</a>
    ...
    <div id = "helpDetail">
        <div class = "hd">
            ...
            <a class = "brand-qa-1 close-help" href = "javascript:;"></a>
            <a class = "brand-qa-2" href = "javascript:;"></a>
        </div>
        <div class = "qa-list">
            <ul class = "nav"></ul>
            <div class = "cont">
                <div class = "questions"></div>
                <div class = "overlay close-help"></div>
    ...
    <script type = "text/javascript" src = "/zhongying1/Pub/home/js/helpDetail.js"></script>
