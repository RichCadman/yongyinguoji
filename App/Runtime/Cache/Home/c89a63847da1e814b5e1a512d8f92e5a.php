...
<body class = "zh">
	...
	<div id="home">
		...
		<div class="content login">
			<div class="wcon">
				<div class="lgright">
					<div class="lrtitle clearfix"> <strong class="fl">账户注册</strong>
						<span class="fr">
							已经注册？
							<a href="/zhongying1/index.php/Mlogin/index">立即登录</a>
						</span>
					</div>
					<div id="lrform">
						<form name="regform" id="regform" action="/zhongying1/index.php/Mreg/reg" onSubmit="return false;">
                         ...
                         onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9]/g,'') " onafterpaste="this.value=this.value.replace(/[^a-zA-Z0-9]/g,'') "/>
							...
							<p class="reg_ckeckbox">
								...
								<a href="/zhongying1/index.php/Mreg/agreement" target="_blank">注册协议</a>
								》</label>
							</p>
