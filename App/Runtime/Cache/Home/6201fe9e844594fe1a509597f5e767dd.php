            ...
            <div class="wcon">
                ...
                <div class="user_right fr">
                    <ul class="tit">
                        ...
                        <li class="nocur">
                            <a href="/zhongying1/index.php/My/deposit_list.html">充值记录</a>
                        </li>
                    </ul>
                    <div class="user_con">
...
<script src="/zhongying1/Pub/home/js/qrcode.js"></script>
...
function paywindow(payname,money,orderno,piccode){
  ...
  if(payname!='支付宝'&&payname!='微信支付'){
    layer.confirm('<div class="paytip">充值银行：<span class="green">'+payname+'</span><br>充值金额：<span class="green">'+money+'</span>元 人民币</div><div class="tipmsg">请点击确认支付，再新打开的页面完成支付</div>', {
      ...
      layer.confirm('<div class="paytip"><div class="loading"><img src="../images/loading.gif">自动检测中，请不要关闭此窗口</div></div><div class="tipmsg">成功完成付款后将自动跳转，若未跳转，请您点击下面的按钮查看订单是否成功</div>', {
        id: 'payconfirm',
        title: '充值中',
        btn: ['查看订单'],
        area: '460px',
...
function qrfun(payname,money,piccode){
  var con = '<div id="qrcode"><div class="qrmsg"><div class="qcenter"><span class="red">'+payname+'</span>扫一扫付款（元）</div><div class="qrmoney">'+money+'</div></div><div class="qrbox"><div id="qrcodepic"></div><div class="qrtip"><img class="fl" src="../images/qricon.png" alt="扫一扫标识"><div class="fl tip">手机打开<span class="red">'+payname+'</span><br>扫一扫继续付款</div></div></div></div>';
  $(".deposit_box").html(con);
    var qrcode;
    $("#qrcodepic").html("");
    // 创建二维码
