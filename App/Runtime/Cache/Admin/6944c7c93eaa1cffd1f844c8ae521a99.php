...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">修改历程</a>  </div>
  <h1>修改历程</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Index/mod_licheng_do/id/<?php echo ($licheng["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            <div class="control-group">
              <label class="control-label">标题 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($licheng["title"]); ?>" name="title" id="title" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">时间 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($licheng["time"]); ?>" name="time" id="time" />
              </div>
            </div>
