...
<link rel="stylesheet" href="/Pub/admin/css/table.css" />
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>菜单栏</a>
  <ul>
    <li> <a href="/admin.php/Index/index.html"><i class="icon icon-home"></i> <span>统计信息</span></a> </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">统计信息</a> </div>
    <h1>统计信息</h1>
  </div>
            ...
            <table  style="overflow:hidden" class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($tongji)): foreach($tongji as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo ($v["type_title"]); ?></td>
                  <td><?php echo ($v["frist"]); ?></td>
                  <td><?php echo ($v["last"]); ?></td>
                  <td><a href="/admin.php/Index/mod_tongji/id/<?php echo ($v["id"]); ?>">修改</a> / <a href="javascript:void()" onclick="del(<?php echo ($v["id"]); ?>)">删除</a></td>
...
<script type="text/javascript">
  function del(id){
    if(confirm("确定删除")){
      window.location="/admin.php/Index/del_tongji/id/"+id;
    }
  }
</script>
<!--Footer-part-->
