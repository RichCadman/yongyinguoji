...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">修改热点新闻</a>  </div>
  <h1>修改热点新闻</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Index/mod_hot_news_do/id/<?php echo ($hot_news["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            <div class="control-group">
              <label class="control-label">标题 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($hot_news["title"]); ?>" name="title" id="title" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">图片 :</label>
              <div class="controls">
                <input type="file" class="span11" name="img" />
            </div>
            <div class="control-group">
              <label class="control-label">链接 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($hot_news["link"]); ?>" name="link" id="link" />
              </div>
            </div>
