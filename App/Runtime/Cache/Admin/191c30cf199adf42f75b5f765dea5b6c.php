...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i>菜单栏</a>
  <ul>
    <li> <a href="/admin.php/Index/tongji_index.html"><i class="icon icon-signal"></i> <span>统计信息</span></a> </li>
    <li> <a href="/admin.php/Index/lianxi.html"><i class="icon icon-pencil"></i> <span>联系我们</span></a> </li>
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">添加新闻</a>  </div>
  <h1>添加新闻</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Index/add_news_do" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="radio" class="span11" value="0" name="new" id="new" checked/>普通新闻
              </div>
              <div class="controls">
              <input type="radio" class="span11" value="1" name="new" id="new" />热点新闻
              </div>
            </div>
            ...
            <div class="controls">
              <div  data-date="" class="input-append date datepicker">
                <input type="text" value="" name="time" id="time" data-date-format="yyyy-mm-dd" class="span11" >
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="link" id="link" />
              </div>
            </div>
            <script type="text/javascript">
              function checkFile(){
            ...
            <div class="controls">
              <input type="file" class="span11" name="img" id="title" />
            </div>
            
            <label class="control-label">内容</label>
            <div class="controls">
              <textarea name="content1"><?php echo ($hot_news["content"]); ?></textarea>
            </div>

            </div>

            <div class="form-actions">
              <button type="submit" onclick="return checkFile()" class="btn btn-success">添加</button>
            </div>
          </form>
        </div>
      </div>
