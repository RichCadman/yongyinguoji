...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">修改统计</a>  </div>
  <h1>修改统计</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Index/mod_tongji_do/id/<?php echo ($tongji["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            <div class="control-group">
              <label class="control-label">标题 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($tongji["type_title"]); ?>" name="type_title" id="type_title" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">参数1 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($tongji["frist"]); ?>" name="frist" id="frist" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">参数2 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($tongji["last"]); ?>" name="last" id="last" />
              </div>
            </div>
