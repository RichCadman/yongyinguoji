...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="tip-bottom">修改</a>  </div>
  <h1>修改</h1>
</div>
    ...
    <div class="widget-box">
      ...
      <div class="widget-content">
        <div class="control-group">
         <form action="/admin.php/Index/mod_lianxi_do/id/<?php echo ($lianxi["id"]); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">

            <div class="control-group">
              <label class="control-label">标题 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($lianxi["title"]); ?>" name="title" id="title" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">内容 :</label>
              <div class="controls">
                <input type="text" class="span11" value="<?php echo ($lianxi["content"]); ?>" name="content" id="content1" />
              </div>
            </div>
