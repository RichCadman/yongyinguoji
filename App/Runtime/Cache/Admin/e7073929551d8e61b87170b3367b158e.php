        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding over">
            <table  style="overflow:hidden" class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($news)): foreach($news as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  ...
                  <td><a href="/zhongying/admin.php/Index/mod_news_zz/id/<?php echo ($v["id"]); ?>">修改</a> / <a href="javascript:void()" onclick="del(<?php echo ($v["id"]); ?>)">删除</a></td>
...
<script type="text/javascript">
  function del(id){
    if(confirm("确定删除")){
      window.location="/zhongying/admin.php/Index/del_news/id/"+id;
    }
  }
</script>
<!--Footer-part-->
