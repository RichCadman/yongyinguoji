...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">联系我们</a> </div>
    <h1>联系我们</h1>
  </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding over">
            <table  style="overflow:hidden" class="table table-bordered data-table">
              ...
              <tbody>
                <?php if(is_array($lianxi)): foreach($lianxi as $k=>$v): ?><tr class="gradeX">
                  <td><?php echo ($k+1); ?></td>
                  <td><?php echo ($v["title"]); ?></td>
                  <td><?php echo ($v["content"]); ?></td>
                  <td><a href="/zhongying/admin.php/Index/mod_lianxi/id/<?php echo ($v["id"]); ?>">修改</a> <!--/ <a href="javascript:void()" onclick="del(<?php echo ($v["id"]); ?>)">删除</a>--></td>
