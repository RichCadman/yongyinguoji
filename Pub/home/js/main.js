...
$(function () {
        ...
        ajax.submit(url, data, function (d) {
            if(d.success=='true'){
                layer.msg('注册成功，请登录！',{icon:1},function(){
                    window.location.href = "http://www.baonakang.com/zhongying1/index.php/Login/index";
                });
            }else{
        ...
        ajax.submit(url, data, function (od) {
            ...
            if (od.success=='true') {
                layer.msg('登录成功，正在加载页面，请稍等！',{icon:1,time:1000},function(){
                    window.location.href = "http://www.baonakang.com/zhongying1/index.php/My/index";
                });
            } else {
                switch (od.error) {
                    case "error3":
    ...
    $(".code-btn").click(function () {
        ...
        var data = {phone: $("#phone").val(), ycode: inputycode},
            url = 'http://www.baonakang.com/zhongying1/index.php/Reg/check';
