var echarts_3fb6b163 = function (modules) {
    ...
    !function (root, factory) {
      ...
      !function () {
        ...
        function getModExports(id) {
          ...
          if (!mod.defined) {
            var factory = mod.factory, factoryReturn = factory.apply(this, getModsExports(mod.deps || [], factory, id));
        ...
        function prepareView(type, ecModel) {
          ...
          for (var i = 0; i < viewList.length;) {
            var view = viewList[i];
            view.__alive ? i++ : (zr.remove(view.group), view.dispose(ecModel, this._api), viewList.splice(i, 1), delete viewMap[view.__id], view.__id = view.group.__ecComponentInfo = null)
          }
        }
        ...
        var env = require("zrender/core/env"), GlobalModel = require("./model/Global"),
          ...
          ChartView = require("./view/Chart"), graphic = require("./util/graphic"), modelUtil = require("./util/model"),
          throttle = require("./util/throttle"), zrender = require("zrender"), zrUtil = require("zrender/core/util"),
          colorTool = require("zrender/tool/color"), Eventful = require("zrender/mixin/Eventful"),
          timsort = require("zrender/core/timsort"), each = zrUtil.each, parseClassType = ComponentModel.parseClassType,
          PRIORITY_PROCESSOR_FILTER = 1e3, PRIORITY_PROCESSOR_STATISTIC = 5e3, PRIORITY_VISUAL_LAYOUT = 1e3,
          PRIORITY_VISUAL_GLOBAL = 2e3, PRIORITY_VISUAL_CHART = 3e3, PRIORITY_VISUAL_COMPONENT = 4e3,
          PRIORITY_VISUAL_BRUSH = 5e3, IN_MAIN_PROCESS = "__flagInMainProcess",
          HAS_GRADIENT_OR_PATTERN_BG = "__hasGradientOrPatternBg", OPTION_UPDATED = "__optionUpdated",
        ...
        return echarts.init = function (dom, theme, opts) {
          ...
          event: "downplay",
          update: "downplay"
        }, zrUtil.noop), echarts.zrender = zrender, echarts.List = require("./data/List"), echarts.Model = require("./model/Model"), echarts.Axis = require("./coord/Axis"), echarts.graphic = require("./util/graphic"), echarts.number = require("./util/number"), echarts.format = require("./util/format"), echarts.throttle = throttle.throttle,
          echarts.matrix = require("zrender/core/matrix"), echarts.vector = require("zrender/core/vector"), echarts.color = require("zrender/tool/color"), echarts.util = {}, each(["map", "each", "filter", "indexOf", "inherits", "reduce", "filter", "bind", "curry", "isArray", "isString", "isObject", "isFunction", "extend", "defaults", "clone", "merge"], function (name) {
        ...
        return Grid.create = function (ecModel, api) {
          ...
          require("../../CoordinateSystem").register("cartesian2d", Grid), Grid
        ...
        function calBarWidthAndOffset(barSeries, api) {
          ...
          zrUtil.each(barSeries, function (seriesModel, idx) {
            ...
            var barWidth = parsePercent(seriesModel.get("barWidth"), bandWidth),
              barMaxWidth = parsePercent(seriesModel.get("barMaxWidth"), bandWidth), barGap = seriesModel.get("barGap"),
        ...
        "use strict";
        var createListFromArray = require("../helper/createListFromArray"), SeriesModel = require("../../model/Series");
        ...
        var zrUtil = require("zrender/core/util"), SymbolDraw = require("../helper/SymbolDraw"),
          Symbol = require("../helper/Symbol"), lineAnimationDiff = require("./lineAnimationDiff"),
        ...
        return ChartView.extend({
          type: "line", init: function () {
            ...
            var coordSys = seriesModel.coordinateSystem, group = this.group, data = seriesModel.getData(),
              ...
              areaStyleModel = seriesModel.getModel("areaStyle.normal"), points = data.mapArray(data.getItemLayout, !0),
              isCoordSysPolar = "polar" === coordSys.type, prevCoordSys = this._coordSys, symbolDraw = this._symbolDraw,
              polyline = this._polyline, polygon = this._polygon, lineGroup = this._lineGroup,
              hasAnimation = seriesModel.get("animation"), isAreaChart = !areaStyleModel.isEmpty(),
              stackedOnPoints = getStackedOnPoints(coordSys, data), showSymbol = seriesModel.get("showSymbol"),
            ...
            if (!(dataIndex instanceof Array) && null != dataIndex && dataIndex >= 0) {
              ...
              if (!symbol) {
                ...
                if (!pt)return;
                symbol = new Symbol(data, dataIndex), symbol.position = pt, symbol.setZ(seriesModel.get("zlevel"), seriesModel.get("z")), symbol.ignore = isNaN(pt[0]) || isNaN(pt[1]), symbol.__temp = !0, data.setItemGraphicEl(dataIndex, symbol), symbol.stopSymbolAnimation(!0), this.group.add(symbol)
              }
              symbol.highlight()
        ...
        var List = require("../../data/List"), zrUtil = require("zrender/core/util"),
          modelUtil = require("../../util/model"), completeDimensions = require("../../data/helper/completeDimensions"),
        ...
        function detect(ua) {
          var os = {}, browser = {}, firefox = ua.match(/Firefox\/([\d.]+)/),
            ie = ua.match(/MSIE\s([\d.]+)/) || ua.match(/Trident\/.+?rv:(([\d.]+))/), edge = ua.match(/Edge\/([\d.]+)/),
        ...
        function mergeTheme(option, theme) {
          zrUtil.each(theme, function (themeItem, name) {
            ComponentModel.hasClass(name) || ("object" == typeof themeItem ? option[name] = option[name] ? zrUtil.merge(option[name], themeItem, !1) : zrUtil.clone(themeItem) : null == option[name] && (option[name] = themeItem))
          })
        }
        ...
        var zrUtil = require("zrender/core/util"), modelUtil = require("../util/model"), Model = require("./Model"),
          ...
          globalDefault = require("./globalDefault"), OPTION_INNER_KEY = "\0_ec_inner", GlobalModel = Model.extend({
            ...
            queryComponents: function (condition) {
              ...
              if (!mainType)return [];
              var index = condition.index, id = condition.id, name = condition.name, cpts = this._componentsMap[mainType];
        ...
        var guid = require("./core/guid"), env = require("./core/env"), zrUtil = require("./core/util"),
          Handler = require("./Handler"), Storage = require("./Storage"), Animation = require("./animation/Animation"),
          HandlerProxy = require("./dom/HandlerProxy"), useVML = !env.canvasSupported,
          painterCtors = {canvas: require("./Painter")}, instances = {}, zrender = {};
        ...
        function hsla2rgba(hsla, rgba) {
          var h = (parseFloat(hsla[0]) % 360 + 360) % 360 / 360, s = parseCssFloat(hsla[1]), l = parseCssFloat(hsla[2]),
            m2 = l <= .5 ? l * (s + 1) : l + s - l * s, m1 = 2 * l - m2;
        ...
        function doGet(obj, pathArr, parentModel) {
          for (var i = 0; i < pathArr.length && (!pathArr[i] || (obj = obj && "object" == typeof obj ? obj[pathArr[i]] : null, null != obj)); i++);
        ...
        return formatUtil.formatTime = function (tpl, value, isUTC) {
          ...
          var date = numberUtil.parseDate(value), utc = isUTC ? "UTC" : "", y = date["get" + utc + "FullYear"](),
            M = date["get" + utc + "Month"]() + 1, d = date["get" + utc + "Date"](), h = date["get" + utc + "Hours"](),
            m = date["get" + utc + "Minutes"](), s = date["get" + utc + "Seconds"]();
        ...
        var UNDEFINED = "undefined", globalObj = "undefined" == typeof window ? global : window,
          Float64Array = typeof globalObj.Float64Array === UNDEFINED ? Array : globalObj.Float64Array,
          Int32Array = typeof globalObj.Int32Array === UNDEFINED ? Array : globalObj.Int32Array,
        ...
        var createListFromArray = require("./chart/helper/createListFromArray"), symbolUtil = require("./util/symbol"),
          axisHelper = require("./coord/axisHelper"), axisModelCommonMixin = require("./coord/axisModelCommonMixin"),
          Model = require("./model/Model"), util = require("zrender/core/util");
        return {
        ...
        return layout.box = boxLayout, layout.vbox = zrUtil.curry(boxLayout, "vertical"), layout.hbox = zrUtil.curry(boxLayout, "horizontal"), layout.getAvailableSize = function (positionInfo, containerRect, margin) {
          ...
          left = left || 0, top = top || 0, isNaN(width) && (width = containerWidth - left - (right || 0)), isNaN(height) && (height = containerHeight - top - (bottom || 0));
        ...
        var TooltipContent = require("./TooltipContent"), zrUtil = require("zrender/core/util"),
          ...
          graphic = require("../../util/graphic"), findPointFromSeries = require("../axisPointer/findPointFromSeries"),
          ...
          axisHelper = require("../../coord/axisHelper"), axisPointerViewHelper = require("../axisPointer/viewHelper"),
          bind = zrUtil.bind, each = zrUtil.each, parsePercent = numberUtil.parsePercent,
        ...
        require("../../echarts").extendComponentView({
          type: "tooltip", init: function (ecModel, api) {
            ...
            cb = zrUtil.bind(cb, this), clearTimeout(this._showTimout),
        ...
        VMLPainter.prototype = {
          constructor: VMLPainter, getViewportRoot: function () {
            ...
            var width = null == width ? this._getWidth() : width, height = null == height ? this._getHeight() : height;
        ...
        require("./MarkerView").extend({
          type: "markLine", updateLayout: function (markLineModel, ecModel, api) {
            ...
            var coordSys = seriesModel.coordinateSystem, seriesName = seriesModel.name,
              seriesData = seriesModel.getData(), lineDrawMap = this.markerGroupMap, lineDraw = lineDrawMap[seriesName];
        ...
        var numberUtil = require("../util/number"), formatUtil = require("../util/format"), Scale = require("./Scale"),
          helper = require("./helper"), roundNumber = numberUtil.round, IntervalScale = Scale.extend({
            type: "interval",
            _interval: 0,
        ...
        function adjustTextPositionOnRect(textPosition, rect, textRect, distance) {
          var x = rect.x, y = rect.y, height = rect.height, width = rect.width, textHeight = textRect.height,
            lineHeight = textRect.lineHeight, halfHeight = height / 2 - textHeight / 2 + lineHeight, textAlign = "left";
          switch (textPosition) {
            case"left":
        ...
        var getLineStyle = require("./makeStyleMapper")([["lineWidth", "width"], ["stroke", "color"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"]]);
        return {
          getLineStyle: function (excludes) {
            var style = getLineStyle.call(this, excludes), lineDash = this.getLineDash(style.lineWidth);
        ...
        var getItemStyle = require("./makeStyleMapper")([["fill", "color"], ["stroke", "borderColor"], ["lineWidth", "borderWidth"], ["opacity"], ["shadowBlur"], ["shadowOffsetX"], ["shadowOffsetY"], ["shadowColor"], ["textPosition"], ["textAlign"]]);
        return {
          getItemStyle: function (excludes, includes) {
            var style = getItemStyle.call(this, excludes, includes), lineDash = this.getBorderLineDash();
            return lineDash && (style.lineDash = lineDash), style
        ...
        function collectSeriesInfo(result, ecModel) {
          ecModel.eachSeries(function (seriesModel) {
            var coordSys = seriesModel.coordinateSystem, seriesTooltipTrigger = seriesModel.get("tooltip.trigger", !0);
        ...
        function buildPayloadsBySeries(value, axisInfo) {
          var axis = axisInfo.axis, dim = axis.dim, snapToValue = value, payloadBatch = [], minDist = Number.MAX_VALUE,
            minDiff = -1;
            ...
            for (var x0, y0, xi, yi, x, y, d = this.data, ux = this._ux, uy = this._uy, len = this._len, i = 0; i < len;) {
              ...
              switch (1 == i && (xi = d[i], yi = d[i + 1], x0 = xi, y0 = yi), cmd) {
                ...
                case CMD.Q:
                  ...
                  break;
                case CMD.A:
                  var cx = d[i++], cy = d[i++], rx = d[i++], ry = d[i++], theta = d[i++], dTheta = d[i++], psi = d[i++],
                    fs = d[i++], r = rx > ry ? rx : ry, scaleX = rx > ry ? 1 : rx / ry, scaleY = rx > ry ? ry / rx : 1,
                    isEllipse = Math.abs(rx - ry) > .001, endAngle = theta + dTheta;
        ...
        return RectText.prototype = {
          constructor: RectText, drawRectText: function (ctx, rect, textRect) {
            ...
            if (null != text && (text += ""), text) {
              ctx.save();
              var x, y, textPosition = style.textPosition, textOffset = style.textOffset, distance = style.textDistance,
                align = style.textAlign, font = style.textFont || style.font, baseline = style.textBaseline,
                verticalAlign = style.textVerticalAlign;
              textRect = textRect || textContain.getBoundingRect(text, font, align, baseline);
        ...
        var CMD = require("../core/PathProxy").CMD, line = require("./line"), cubic = require("./cubic"),
          ...
          windingLine = require("./windingLine"), containStroke = line.containStroke, PI2 = 2 * Math.PI, EPSILON = 1e-4,
          roots = [-1, -1, -1], extrema = [-1, -1];
        return {
        ...
        var vec2 = require("./vector"), curve = require("./curve"), bbox = {}, mathMin = Math.min, mathMax = Math.max,
          mathSin = Math.sin, mathCos = Math.cos, start = vec2.create(), end = vec2.create(), extremity = vec2.create(),
          PI2 = 2 * Math.PI;
        ...
        "use strict";
        var SeriesModel = require("../../model/Series"), createListFromArray = require("../helper/createListFromArray");
        return SeriesModel.extend({
        ...
        function isDisplayableCulled(el, width, height) {
          return tmpRect.copy(el.getBoundingRect()), el.transform && tmpRect.applyTransform(el.transform), viewRect.width = width, viewRect.height = height,
        ...
        return Painter.prototype = {
          constructor: Painter, isSingleCanvas: function () {
            ...
            dpr = dpr || this.dpr;
            var canvas = document.createElement("canvas"), ctx = canvas.getContext("2d"), rect = path.getBoundingRect(),
              style = path.style, shadowBlurSize = style.shadowBlur, shadowOffsetX = style.shadowOffsetX,
              shadowOffsetY = style.shadowOffsetY, lineWidth = style.hasStroke() ? style.lineWidth : 0,
        ...
        var List = require("../../data/List"), completeDimensions = require("../../data/helper/completeDimensions"),
          ...
          converDataValue = modelUtil.converDataValue, creators = {
            cartesian2d: function (data, seriesModel, ecModel) {
              ...
              var xAxisType = xAxisModel.get("type"), yAxisType = yAxisModel.get("type"),
                dimensions = [{name: "x", type: getDimTypeByAxis(xAxisType), stackable: isStackable(xAxisType)}, {
                  name: "y",
        ...
        var Symbol = graphic.extendShape({
          ...
          createSymbol: function (symbolType, x, y, w, h, color) {
            ...
            }) : 0 === symbolType.indexOf("path://") ? graphic.makePath(symbolType.slice(7), {}, new BoundingRect(x, y, w, h)) : new Symbol({
              shape: {
        ...
        var graphic = require("../../util/graphic"), Symbol = require("./Symbol"),
        ...
        return symbolProto._updateCommon = function (data, idx, symbolSize, seriesScope) {
          ...
          var itemStyle = seriesScope && seriesScope.itemStyle,
            ...
            symbolOffset = seriesScope && seriesScope.symbolOffset, labelModel = seriesScope && seriesScope.labelModel,
        ...
        }, zrUtil.inherits(Symbol, graphic.Group), Symbol
        ...
        var layout = require("../../util/layout"), formatUtil = require("../../util/format"),
        ...
        return {
          layout: function (group, componentModel, api) {
            ...
            layout.box(componentModel.get("orient"), group, componentModel.get("itemGap"), rect.width, rect.height), positionGroup(group, componentModel, api)
        ...
        var zrUtil = require("zrender/core/util"), numberUtil = require("../../util/number"), indexOf = zrUtil.indexOf,
          curry = zrUtil.curry, markerTypeCalculator = {
        ...
        var graphic = require("../../util/graphic"), LineGroup = require("./Line"), lineDrawProto = LineDraw.prototype;
        ...
        var axisPointerModelHelper = require("../axisPointer/modelHelper"),
          AxisView = require("../../echarts").extendComponentView({
            ...
            render: function (axisModel, ecModel, api, payload) {
              this.axisPointerClass && axisPointerModelHelper.fixValue(axisModel), AxisView.superApply(this, "render", arguments), updateAxisPointer(this, axisModel, ecModel, api, payload, !0)
            },
        ...
        function makeDispatchAction(api) {
          var pendings = {showTip: [], hideTip: []}, dispatchAction = function (payload) {
        ...
        function assembleCssText(tooltipModel) {
          var cssText = [], transitionDuration = tooltipModel.get("transitionDuration"),
            backgroundColor = tooltipModel.get("backgroundColor"), textStyleModel = tooltipModel.getModel("textStyle"),
