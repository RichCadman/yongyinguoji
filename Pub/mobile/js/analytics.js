(function () {
  ...
  var ea = function (a) {
    ...
    var c = a.indexOf(b);
    if (5 == c || 6 == c)if (a = a.charAt(c + b.length), "/" == a ||
      "?" == a || "" == a || ":" == a)return !0;
    return !1
  }, ya = function (a, b) {
    var c = M.referrer;
  ...
  var oc = function () {
    ...
    1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j60", "sr=1"], b && a.push("_f=" + b), c && a.push("_m=" + K(c.substring(0, 100))), a.push("aip=1"), a.push("z=" + hd()), wc(oc() + "/collect", a.join("&"),
      ua))
  };
  var h = function (a) {
  ...
  var ub = S("eventCategory", "ec"), xb = S("eventAction", "ea"), yb = S("eventLabel", "el"),
    ...
    Db = S("socialTarget", "st"), Eb = S("l1", "plt"), Fb = S("l2", "pdt"), Gb = S("l3", "dns"), Hb = S("l4", "rrt"),
    Ib = S("l5", "srt"), Jb = S("l6", "tcp"), Kb = S("l7", "dit"), Lb = S("l8", "clt"), Mb = S("timingCategory", "utc"),
    Nb = S("timingVar", "utv"), Ob = S("timingLabel", "utl"), Pb = S("timingValue", "utt");
  S("appName", "an");
  S("appVersion", "av", "");
  S("appId", "aid", "");
  ...
  var Qb = T("_oot"), dd = S("previewTask"), Rb = S("checkProtocolTask"), md = S("validationTask"),
    ...
    Ld = S("displayFeaturesTask"), oa = S("customTask"), V = T("name"), Q = T("clientId", "cid"), n = T("clientIdTime"),
    xd = T("storedClientId"), Ad = S("userId", "uid"), Na = T("trackingId", "tid"), U = T("cookieName", void 0, "_ga"),
    W = T("cookieDomain"), Yb = T("cookiePath",
  ...
  var hc = !1, mc = function (a) {
    ...
    if (a.get(Wc)) {
      var b =
        P(a, W), c = P(a, $b) || xa(), d = Xc("__utma", c, b);
  ...
  var H = function (a) {
    ...
    if (b && b.getEntriesByName) {
      J(35);
      var c = "script/analytics.js?wpid=" + a;
      wa(c, void 0, void 0, function () {
        try {
          var d = 1, e = b.getEntriesByName("script/analytics.js");
  ...
  var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function (a) {
    ...
    if ("cookie" == P(a, ac)) {
      ...
      c && (hc = !0);
      if (d =
          c && !a.get(Hd))if (d = c.split("."), 2 != d.length) d = !1; else if (d = Number(d[1])) {
        var e = R(a, Zb);
    ...
    if (a.get(Hd))a:if (c = a.get(cc), d = E(M.location[c ? "href" : "search"], "_ga"))if (a.get(bc))if (c = d.indexOf("."), -1 == c) J(22); else {
      e = d.substring(0, c);
      ...
      g = g.substring(c + 1);
      if ("1" == e) {
        if (c = g, d != Ic(c, 0) && d != Ic(c, -1) && d != Ic(c, -2) && d != pa(c,
            0) && d != pa(c, -1) && d != pa(c, -2)) {
          J(23);
          break a
        }
